...
public final class FlagListener implements Listener {
    ...
    private FlagListener(DatabaseManager databaseManager, Logger logger, Values values, DataManager manager) {
    ...
    public static FlagListener getInstance(DatabaseManager databaseManager, Logger logger, Values values, DataManager manager) {
        return instance != null ? instance : (instance = new FlagListener(databaseManager, logger, values, manager));
    }
